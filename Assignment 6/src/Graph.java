...
class Vertex
{
    public String     number;   // Vertex name
    ...
    public Vertex( String nm )
      { number = nm; adj = new LinkedList<Edge>( ); name = ""; reset( ); }
        ...
        while( !pq.isEmpty( ) && nodesSeen < vertexMap.size( ) )
        {
            ...
            for( Edge e : v.adj )
            {
                ...
                if( w.dist > v.dist + cvw )
                {
                    ...
                    // if(edge exists)
                    // {
                    //     Edge d = w.adj //path back to v
                    //     double cvwv = cvw + d.cost
    
                    //     if(v.dist + w.dist > w.dist + cvwv )
                    //     {
                    //         //assign new values to stuff
                    //         pq.add( new Path( w, w.dist ) );
                    //     }
                    // }
                }
